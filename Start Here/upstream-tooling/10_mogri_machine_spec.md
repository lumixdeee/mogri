...
* Return paths exist but carry much higher cost
...
* Reversibility is simulated but not actually available in the state graph
...
If either condition fails, progmogriess is impossible under this state graph.
...
* Mogri is a property of the transition graph, not an appearance
